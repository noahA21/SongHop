...
namespace SongHop.Data.Migrations
{
    ...
    [Migration("20260607150508_IngestLastFmGenresAndEdgeContext")]
    partial class IngestLastFmGenresAndEdgeContext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SongHop.Core.Models.Edge", b =>
                {
                    ...
                    b.HasIndex("SourceId", "TargetId", "Type", "ContextTitle")
                        .IsUnique();
